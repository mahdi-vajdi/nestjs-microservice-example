...
import { IdentityEventsNatsController } from './identity-events.nats.controller';

describe('IdentityEventsNatsController', () => {
  let controller: IdentityEventsNatsController;
  ...
  beforeEach(() => {
    ...
    controller = new IdentityEventsNatsController(sseService as SseService);
  });
